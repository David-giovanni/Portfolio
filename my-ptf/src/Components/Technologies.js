  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <FaHtml5 className="text-7xl text-orange-500 rounded-xl" />
        </motion.div>
        <motion.div
          variants={iconVariants(2.5)}
          initial="initial"
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaCss3 className="text-7xl text-blue-500 rounded-xl" />
        </motion.div>
        <motion.div
          variants={iconVariants(2.5)}
          initial="initial"
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaNodeJs className="text-7xl text-green-500 rounded-xl" />
        </motion.div>
        <motion.div
          variants={iconVariants(2.5)}
          initial="initial"
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaJava className="text-7xl text-black bg-white rounded-xl" />
        </motion.div>
        <motion.div
          variants={iconVariants(6)}
          initial="initial"
